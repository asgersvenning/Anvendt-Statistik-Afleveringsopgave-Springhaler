...
We thus find no significant effect of *temperature* on asymptotic *osmolality*, but the additive effect between *hours* we observe that *temperature* have an significant effect.
