...
This concludes that the springtails' osmolality is effected by the drought but that the temperature does not have a signifikant effect on springtails' osmolality.
