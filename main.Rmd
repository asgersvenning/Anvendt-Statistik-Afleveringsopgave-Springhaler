...
OsmoTime %>% paged_table()
DroughtTemp %>% paged_table()
```
...
Please answer the following questions using R and write a report. (Hint: Temperature is most appropriate to analyze as a categorical variable)
...
Which show no clear trend and a reasonable normal distribution in the residuals. 


</br>

## Use the above saturation model and the dataset "Osmolality with time". Fit the best line to each of the four temperature.
<sub>*(hint: use 1/Osmolality and 1/Hours as y and x variables, respectively)*</sub>
